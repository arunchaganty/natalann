...
const {buildDevConfig} = require('../config/webpack.config.base');
const createDevServerConfig = require('../config/webpackDevServer.config.base');
...
const config = buildDevConfig(paths);
